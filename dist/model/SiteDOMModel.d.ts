...
export interface SiteNode {
    ...
    semantic: {
        role?: string;
        roleSource?: 'explicit' | 'implicit';
        name?: string;
        nameSource?: 'aria-labelledby' | 'aria-label' | 'label' | 'alt' | 'text' | 'title';
        text?: string;
        title?: string;
        alt?: string;
        ariaHidden?: boolean;
...
export interface SiteDOMModel {
    ...
    coverage: {
        tree: 'composed-open-shadow';
        iframes: 'boundary-only';
        truncated: boolean;
    };
}
